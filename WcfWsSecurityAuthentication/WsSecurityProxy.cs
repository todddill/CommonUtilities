...
namespace WcfWsSecurityAuthentication
{
    public class WsSecurityProxy
    {
        ...
        public T CreateSoap11Proxy<T>(string endpoint, string username, string password)
        {
            ...
            var securityElement = TransportSecurityBindingElement.CreateUserNameOverTransportBindingElement();
            ...
            CustomCredentials credentials = new CustomCredentials(SecurityVersion.WSSecurity11);
